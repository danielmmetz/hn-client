        ...
        <div class="story-detail-title-row">
          ...
          {story.url && (
            onReaderView ? (
              ...
              >
                <svg viewBox="1 2 22 20" width="22" height="20" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          >
            <svg viewBox="3 1 18 22" width="18" height="22" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
